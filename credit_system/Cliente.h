...
void agregar_cliente(char nombre[], char apellido[], int edad, int dni, char mail[]); // agrega un nuevo cliente a la lista enlazada
void listar_clientes(void); // muestra la lista de clientes --- cambiar a que muestre menos del total?
...
int obtener_id(int id); // obtiene una id que no esté en uso para nuevos clientes -- OPTIMIZAR O REWORKEAR
